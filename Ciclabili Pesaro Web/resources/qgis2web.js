...
map.getView().fit([1430044.236738, 5444861.384421, 1442870.923897, 5454608.759983], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Rete Bicipolitana del Comune di Pesaro</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (64 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Dati vettoriali: Geoportale Pesaro / Elaborazione: Andrea - 2026';
            }
